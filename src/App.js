      ...
      <div className="App">
        ...
        <main>
          <Switch>
            ...
            <Route exact path="/punches/:id/edit" component={({ history, match }) => <ClockEdit current_user={this.state.user.id} punches={this.props.punches} history={history} match={Number(parseInt(match.params.id))} isLoggedIn={this.state.isLoggedIn} statusMessage={this.statusMessage} />} />
            <Route exact path="/clients" component={({ history }) => <ClientContainer history={history} current_user={this.state.user.id} clients={this.props.clients} punches={this.props.punches} isLoggedIn={this.state.isLoggedIn} />} />
